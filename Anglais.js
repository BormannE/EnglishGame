...
var tab1_reponse = [
    ...
    ["Lily of the valley","muguet","daisy","dandelion"],
    ["pansy","dandelion","daisy","small bell"],
    ["squirrel","groundhog","sealskin","burrow"],
    ["elk","hind","hirsch","wild boar"],
    ["Woodpecker","crane","crow","parrot"],
    ["stork","crane","crow","magpie"],
    ["chicks","chicken","rooster","hen"],
    ["Corcovado","Statue of Liberty","Little Mermaid","Moai"],
    ["Niagara Falls","Sutherland Falls","Plitvice Waterfalls","Yosemite Falls"],
    ["Westminster Parliament","Westminster Abbaye","Buckingham Palace","Windsor Castle"],
    ["Neuschwanstein Castle","Windsor Castle","Portchester Castle","Carisbrooke Castle"],
    ["Tower Bridge","Ponte Vecchio","Golden Gate Bridge","Sydney Harbour Bridge"],
    ["Statue of Liberty","Corcovado","Moai","Little Mermaid"],
    ["Golden Gate Bridge","Tower Bridge","Ponte Vecchio","Sydney Harbour Bridge"],
    ["Sydney Opera House","Q1","121 Collins Street","Royal Exhibition Building"],
    ["Giant's Causeway","Plymouth Rock","The Blarney Stone","The Rock of Gibraltar"],
    ["Empire State Building","Trump Building","Krysler Building","Flatiron Building"],
    ["Florence","Venice","Roma","Naples"],
    ["Venice","Florence","Roma","Naples"],
    ["Cinqueterre","Positano","Nice","Strasbourg"],
    ["Barcelona","New York","San Francisco","Chicago"],
    ["Dublin","Cargiff","Galway","Edinburgh"]
];
